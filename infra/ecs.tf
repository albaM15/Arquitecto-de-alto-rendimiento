...
resource "aws_security_group" "alb" {
  ...
  description = "Permite HTTP publico hacia el ALB"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "MODEL_S3_BUCKET", value = aws_s3_bucket.model_artifacts.bucket },
        { name = "PREDICTIONS_TABLE", value = aws_dynamodb_table.predictions.name },
